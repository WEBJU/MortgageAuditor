...
class AccountController extends Controller
{
    public function account() 
    {
        ...
        return view('personal.account', ['myuser' => $myuser]);
    }
    ...
    public function updateUser(Request $request) 
    {
        ...
        if($id == null) 
        {
            return redirect('personal/account')->with('error', trans("Invalid request"));
        }
        ...
        return redirect('personal/account')->with('success', trans("Update was successful"));
    }
    ...
    public function updatePassword(Request $request) 
    {
        ...
        {
            return redirect('personal/account')->with('error', trans("The new passwords must match"));
        }
        ...
        if(Hash::check($c_password, $password)) 
        {
            ...
            return redirect('personal/account')->with('success', trans("Password is successfully updated"));
        } else {
            return redirect('personal/account')->with('error', trans("Wrong credentials"));
        }
    }
}
