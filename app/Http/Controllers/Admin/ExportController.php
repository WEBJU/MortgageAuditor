...
class ExportController extends Controller
{
	...
	function users() 
	{
		...
		foreach ($users as $user) 
		{
			...
			// 	$a_type = 'Employee';
			// }
			Storage::prepend($file, str_replace(",", "", $user->employee_id) .','. "$user->churn_status" .','. "$user->churn_status");
			Storage::prepend($file, 'EMPLOYEE ID' .','. 'CHURN STATUS' .','. 'DATE');
