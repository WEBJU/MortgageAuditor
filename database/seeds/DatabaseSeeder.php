...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('people')->insert([
            ['id' => 1,'firstname' => 'HR','lastname' => 'Manager','emailaddress' => 'manager@example.com','birthday' => '2020-02-01','employmentstatus' => 'Active'],
        ...
        DB::table('report_views')->insert([
            ...
            ['id' => 2,'report_id' => 2,'last_viewed' => '','title' => 'Employee Prediction Report'],
        ...
        DB::table('users')->insert([
            ['id' => '1','reference' => '1','idno' => '001122','name' => 'HR, MANAGER','email' => 'hr@gmail.com','role_id' => '1','acc_type' => '2','status' => '1','password' => '$2y$10$mDAH.R8JG5ThPelt4zRXc.8sxizt.tqXQfndx5s/W/3j0Sq6xS3LG','remember_token' => '','created_at' => '2018-10-31 20:10:04','updated_at' => '2018-10-31 20:10:04'],
