...
@section('content')
                ...
                <div class="col-sm-10 col-md-10 col-lg-10">
                    <div class="card border-0 shadow-sm my-3 overflow-hidden">
                        <div class="row no-gutters">
                            ...
                            <div class="col-md-6 p-3 p-sm-3 p-md-4 p-lg-5">
                                <div class="text-center mt-3 mb-4">
                                    <h1 class="font-weight-bolder text-primary">Employee Attrition</h1>
                                </div>
                                <form action="" method="get" autocomplete="off">
                                    <div class="form-group text-center">
                                        <label for="idno" class="lead">{{ __("Enter Your ID Number") }}</label>
                                        <input type="text" name="idno" class="form-control text-uppercase" placeholder="" autofocus required>
                                    </div>
                                    <div class="form-row">
                                        <div class="col mb-3">
                                            <button id="btn-clockin" type="button" data-method="clockin" class="btn btn-success btn-block">
                                                {{ __("Clock IN") }}
                                            </button>
                                        </div>
                                        <div class="col mb-3">
                                            <button id="btn-clockout" type="button" data-method="clockout" class="btn btn-primary btn-block">
                                                {{ __("Clock OUT") }}
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 p-3 p-sm-3 p-md-4 p-lg-5 bg-blue">
                                <div class="row h-100">
                                    <div class="col-sm-12 my-auto">
                                        <p  class="text-white mt-3 mb-0 lead"><span id="current-day" class="text-capitalize"></span>, <spam id="current-date" class="text-capitalize"></spam></p>
                                        <h1 id="current-time" class="display-4 text-white"></h1>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="position-fixed p-3 d-flex justify-content-center align-items-center" aria-live="polite" aria-atomic="true" style="z-index: 9; left: 0; right: 0; bottom: 0;">
        <!-- notification -->
