...
@section('meta')
    <title>Users | Mortgage Auditor</title>
    ...
    <div class="row">
        <div class="col-md-12 page-header">
            <h2 class="page-title">
                ...
                <a href="{{ url('admin/users/add') }}" class="btn btn-outline-primary btn-sm float-right">
                    <i class="fas fa-plus"></i><span class="button-with-icon">{{ __("Add New User") }}</span>
                </a>

                {{-- <a href="{{ url('admin/user/roles') }}" class="btn btn-outline-success btn-sm mr-2 float-right">
